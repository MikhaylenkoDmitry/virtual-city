...
function generateCastleObject3d(x, y, z, width, height, depth) {
    ...
    var down_left_tower = generateTowerMesh(x, -5, z, width, height, depth);
    group.add(down_left_tower);
    var down_right_tower = generateTowerMesh(x, -5, z + tower_distance, width, height, depth);
    group.add(down_right_tower);
    var up_left_tower = generateTowerMesh(x + tower_distance, -5, z, width, height, depth);
    group.add(up_left_tower);
    var up_right_tower = generateTowerMesh(x + tower_distance, -5, z + tower_distance, width, height, depth);
    ...
    var down_wall1 = generateCommonWallMesh(x + width / 2 - width / (2 * WALL_WIDTH_RATIO),
        ...
        height * WALL_HEIGHT_RATIO, (depth * 3) / 4);
